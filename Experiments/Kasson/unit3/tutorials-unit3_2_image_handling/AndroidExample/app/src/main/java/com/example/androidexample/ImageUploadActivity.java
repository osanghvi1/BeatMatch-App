...
public class ImageUploadActivity extends AppCompatActivity {
    ...
    private void uploadImage(){
        ...
        // Example to ensure correct usage
        Map<String, String> paramsMap = Collections.emptyMap();
        byte[] byteArrayData = new byte[0];
        MultipartRequest multipartRequest = new MultipartRequest(
                Request.Method.POST, // Method (POST or GET)
                "http://example.com/upload", // Your URL
                byteArrayData, // Your byte array data
                paramsMap, // Any parameters you need to send
                response -> {
